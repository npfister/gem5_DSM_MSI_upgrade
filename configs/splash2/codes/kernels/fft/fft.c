...

{
  ...
  x = (double *) _parmacs_memory_alloc((int)(2*(N+rootN*pad_length)*sizeof(double)+PAGE_SIZE));;
  trans = (double *) _parmacs_memory_alloc((int)(2*(N+rootN*pad_length)*sizeof(double)+PAGE_SIZE));;
  umain = (double *) _parmacs_memory_alloc((int)(2*rootN*sizeof(double)));;  
  umain2 = (double *) _parmacs_memory_alloc((int)(2*(N+rootN*pad_length)*sizeof(double)+PAGE_SIZE));;

  Global->transtimes = (int *) _parmacs_memory_alloc((int)(P*sizeof(int)));;  
  Global->totaltimes = (int *) _parmacs_memory_alloc((int)(P*sizeof(int)));;  
  if (Global == NULL) {
