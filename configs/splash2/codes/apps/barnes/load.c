...
#line 57
	 ...
	 {
#line 60
    _parmacs_unlock(Global->io_lock);
#line 60
};
      }
   }
   {
#line 63
    _parmacs_barrier((Global->Bartree), (NPROC));
#line 63
};
   hackcofm( 0, ProcessId );
   {
#line 65
    _parmacs_barrier((Global->Barcom), (NPROC));
#line 65
};
}
   ...
   unsigned ProcessId;
{
   ...
   while (flag) {                           /* loop descending tree     */
	 ...
	 {
#line 243
    _parmacs_alock((CellLock->CL), (((cellptr) mynode)->seqnum % MAXLOCK));
#line 243
};
	 if (*qptr == NULL) {
	 ...
	 {
#line 254
    _parmacs_aulock((CellLock->CL), (((cellptr) mynode)->seqnum % MAXLOCK));
#line 254
};
