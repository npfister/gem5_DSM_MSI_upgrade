    ...
    while (curr_box) {
        ...
        while (curr_ptr) {  
            ...
            if ((X_INDEX != i) || 
                ...
                {
    _parmacs_lock(BOX[i][j][k].boxlock);
};
                if (last_ptr != NULL) 
