...

{
   ...
   fields = (struct fields_struct *) _parmacs_memory_alloc((int)(sizeof(struct fields_struct)));;
   fields2 = (struct fields2_struct *) _parmacs_memory_alloc((int)(sizeof(struct fields2_struct)));;
   wrk1 = (struct wrk1_struct *) _parmacs_memory_alloc((int)(sizeof(struct wrk1_struct)));;
   wrk3 = (struct wrk3_struct *) _parmacs_memory_alloc((int)(sizeof(struct wrk3_struct)));;
   wrk2 = (struct wrk2_struct *) _parmacs_memory_alloc((int)(sizeof(struct wrk2_struct)));;
   wrk4 = (struct wrk4_struct *) _parmacs_memory_alloc((int)(sizeof(struct wrk4_struct)));;
   wrk6 = (struct wrk6_struct *) _parmacs_memory_alloc((int)(sizeof(struct wrk6_struct)));;
   wrk5 = (struct wrk5_struct *) _parmacs_memory_alloc((int)(sizeof(struct wrk5_struct)));;
   frcng = (struct frcng_struct *) _parmacs_memory_alloc((int)(sizeof(struct frcng_struct)));;
   iter = (struct iter_struct *) _parmacs_memory_alloc((int)(sizeof(struct iter_struct)));;
   guess = (struct guess_struct *) _parmacs_memory_alloc((int)(sizeof(struct guess_struct)));;
